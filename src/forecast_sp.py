...
engine = create_engine("postgresql://sdcmktops:SDCsdc1234@postgres-1.cvh49u2v99nl.ap-southeast-1.rds.amazonaws.com/postgres", echo=False)
conn = engine.connect()
...
# %%
vc_per = pd.read_sql('SELECT * FROM "vesting_contract_period"', conn)
vc_per.head(2)
